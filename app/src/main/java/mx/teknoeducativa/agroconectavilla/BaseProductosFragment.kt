...
abstract class BaseProductosFragment : Fragment() {
    ...
    // Adaptador
    protected lateinit var adapter: mx.teknoeducativa.agroconectavilla.adapter.ProductoAdapter

    // Lista productos
    protected val lista = mutableListOf<mx.teknoeducativa.agroconectavilla.network.Producto>()
    ...
    // URL productos
    protected val url: String= _root_ide_package_.mx.teknoeducativa.agroconectavilla.utils.Constants.BASE_URL + "api/productos/"
