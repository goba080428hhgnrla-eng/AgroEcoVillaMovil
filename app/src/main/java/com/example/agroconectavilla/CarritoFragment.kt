...
class CarritoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnContinuar.setOnClickListener {
            val intent = Intent(requireContext(), ConfirmacionPedidoActivity::class.java)
            // Pasamos el ID del usuario para que la pantalla del mapa sepa de quién es el pedido
