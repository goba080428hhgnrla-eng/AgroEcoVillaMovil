...
class CarritoAdapter(
    ...
    private val onCantidadChange:
        (CarritoItem, Int) -> Unit,

    private val onEliminar:
        (CarritoItem) -> Unit
    ...
    inner class ViewHolder(v: View) :
        ...
        val subtotal: TextView =
            v.findViewById(R.id.txtSubtotal)

        val txtCantidad: TextView =
            v.findViewById(R.id.txtCantidad)

        val btnMenos: ImageButton =
            v.findViewById(R.id.btnMenos)

        val btnMas: ImageButton =
            v.findViewById(R.id.btnMas)

        val btnEliminar: ImageButton =
            v.findViewById(R.id.btnEliminar)
    }
